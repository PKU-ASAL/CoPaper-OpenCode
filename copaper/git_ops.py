...
the CoPaper pipeline phases. Each commit is tagged with a phase prefix
(e.g. ``[storyline]``) and includes a CoPaper co-author trailer.
"""
...
class GitManager:
    """Manage git operations for the CoPaper pipeline.
    ...
    def commit_phase(
        ...
        formatted_message = (
            f"[{phase}] {message}\n\nCo-authored-by: CoPaper AI <ai@copaper>"
        )
