...
from copaper.constants import PHASE_DEPENDENCIES, PHASE_ORDER, Phase, PhaseStatus
...
class StateManager:
    """Manages the .agents/state.json file for a CoPaper project.
    ...
    def load(self) -> dict[str, Any]:
        ...
        if not self._state_file.exists():
            raise StateFileError(
                ...
                "Run 'copaper init' to create a new project."
            )
