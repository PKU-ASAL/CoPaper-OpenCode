...
:class:`vibepaper.literature.LiteratureCatalog`, and writes them to a cache
file (default ``relatedwork/search_cache.json``) ready to be imported via
``vibe relatedwork import``.
"""
...
from vibepaper.literature import (
    _generate_paper_id,
    _normalize_authors,
    extract_bibtex_key,
)
...
DEFAULT_TIMEOUT = 30
DEFAULT_RETRIES = 4
USER_AGENT = "VibePaper/0.1 (+https://vibepaper.local)"
