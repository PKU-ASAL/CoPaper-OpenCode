...
- User requests to find relatedwork (e.g., "find related work", "查找相关工作")
...
You need to find papers that have similar insights but in different problem domains. This will help to check whether the insight has been discovered in other domains, which can also indicate the novelty of the insight in the context of the problem domain mentioned in general.md.
